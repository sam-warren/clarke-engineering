...
export function ShopCapabilitiesPage() {
  return (
    <div className="space-y-8">
      <h1 className="text-4xl font-bold text-center mb-10">Shop Capabilities</h1>
      
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-3xl font-semibold">Our 6,000 sq ft Facility</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="mb-3 text-lg text-gray-700">
            Detailed information about our welding and machining shop, equipment, capacity, and technologies used.
          </p>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-3xl font-semibold">Equipment Highlights</CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="list-disc list-inside space-y-2 text-lg text-gray-700">
            <li>Equipment Item 1 - Placeholder description</li>
            <li>Equipment Item 2 - Placeholder description</li>
            <li>Equipment Item 3 - Placeholder description
