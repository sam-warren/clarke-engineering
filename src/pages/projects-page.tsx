...
const projectsData: Project[] = [
  {
    ...
    description:
      'Iconic archway restoration project in downtown Victoria. Involved intricate metalwork and structural reinforcement.',
  ...
  },
  {
    ...
    description:
      'Extensive hull repairs and custom fabrication for a commercial fishing vessel, ensuring seaworthiness and longevity.',
  ...
  },
  {
    ...
    description:
      'Designed and fabricated specialized material handling equipment for a local manufacturing plant, improving operational efficiency.',
  ...
  },
  {
    ...
    description:
      'Custom designed and crafted ornamental steel gate for a private residence, blending security with aesthetic appeal.',
            ...
            <div className="p-6 pt-0">
              {project.tags.map((tag) => (
                <Badge
                  key={tag}
                  variant="secondary"
                  className="mr-2 mb-2 bg-red-100 text-red-700 border-red-300"
                >
                  {tag}
                </Badge>
              ))}
